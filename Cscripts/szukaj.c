...
void ObliczLPSTab(char *P, int m, int *longestprefixsuffix) {
    ...
    printf("%d \n%d \n%d \n ", longestprefixsuffix[0],longestprefixsuffix[1],longestprefixsuffix[2]);
    printf("%d \n%d \n%d \n ", longestprefixsuffix[3],longestprefixsuffix[4],longestprefixsuffix[5]);
}
...
int main(int argc, char** argv) {
    ...
    WczytajDoTabeli(T, "text.txt");
    //    printf("\n");
    //WczytajDoTabeli(P, "wzor.txt");
    WczytajDoTabeli(P, "pattern.txt");
    //    printf("\n");
    //    printf("\n%s", T);
    //   printf("\n%s", P);
    //    printf("\n");
